          ...
          <div className="flex flex-wrap justify-between items-center min-h-[6rem] py-4 gap-y-4">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="relative" ref={languageMenuRef}>
                ...
                {showLanguageMenu && (
                  <div className="absolute left-0 sm:right-0 top-12 w-40 max-w-[calc(100vw-2rem)] -translate-x-[max(0px,calc(100%-100vw+1rem))] bg-white dark:bg-[#1F2937] border border-gray-100 dark:border-white/10 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-black/50 py-2 z-50 animate-fade-in text-gray-900">
